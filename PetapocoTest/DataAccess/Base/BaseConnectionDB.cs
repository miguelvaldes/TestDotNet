...
namespace DataAccess.Base
{
    ...
    {
        public BaseConnectionDB() : base("BaseConnection")
        {
            CommonConstruct();
        }

        public BaseConnectionDB(string connectionStringName) : base(connectionStringName)
        {
            CommonConstruct();
        }
        ...
        [ThreadStatic]
        static BaseConnectionDB _instance;
